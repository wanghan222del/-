...
# clone projects
RUN cd src && git clone https://gitee.com/LihanChen2004/rm_auto_aim --depth=1 && \
    git clone https://gitee.com/LihanChen2004/ros2_mindvision_camera --depth=1 && \
    git clone https://gitee.com/LihanChen2004/ros2_hik_camera --depth=1 && \
    git clone https://gitee.com/LihanChen2004/rm_gimbal_description --depth=1 && \
    git clone https://gitee.com/LihanChen2004/rm_serial_driver --depth=1 && \
    git clone https://gitee.com/LihanChen2004/rm_vision --depth=1 
